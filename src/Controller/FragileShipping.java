 ...
 */
public class FragileShipping extends Shipping{
    ...
    private final double FragileProductShippingCost = 3.5;
    ...
    public double calculateShippingCost(JTable table, String address) {
        ...
        for(int rowCount = 0; rowCount < table.getRowCount(); rowCount++) {
            ...
            if(packagingType.equals("Fragile")){
                packagingPrice += FragileProductShippingCost;
            }
